...
class DocumentIndex extends ArrayList<IndexEntry>
{
   ...
   word = word.toUpperCase();
      ...
      ListIterator<IndexEntry> i = this.listIterator();
      while(i.hasNext() && n.compareTo(this.get(x)) >= 0)
      {
      if(n.compareTo(this.get(x)) == 0)
            return x;
         x++;
         i.next();
      }
      //String z = ((this.get(x)).getWord());
